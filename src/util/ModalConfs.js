...
const modalConfigurations = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label:
          "Do you want to include a default project? This only works if you are a new user",
        tooltip: "Default project?",
        inputType: "checkbox",
      },
    ],
  },
    ...
    fields: [
      {
        ...
        id: "clear-data",
        name: "clear-data",
        label: "Do you want to clear your personal data?",
        tooltip: "Clear your data?",
        inputType: "checkbox",
      },
    ],
  },
    ...
    fields: [
      {
        ...
        name: "project-title",
        label: "Project Title",
        tooltip: "Enter the project's title",
        inputType: "text",
      },
      {
        type: "textarea",
        ...
        tooltip: "Enter the project's description",
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        name: "task-title",
        label: "Task Title",
        tooltip: "Enter the task's title",
        inputType: "text",
      },
      {
        type: "textarea",
        ...
        tooltip: "Enter the task's description",
      },
      {
        type: "input",
        id: "task-due-date",
        name: "task-due-date",
        label: "Due Date",
        tooltip: "Enter the task due date",
        inputType: "date",
      },
      {
        type: "select",
        ...
        name: "task-priority",
        label: "Priority",
        tooltip: "Select the task priority",
        options: [
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        name: "task-status",
        label: "Status",
        tooltip: "Select the task status",
        options: [
          { text: "To Do", value: Status.TODO },
